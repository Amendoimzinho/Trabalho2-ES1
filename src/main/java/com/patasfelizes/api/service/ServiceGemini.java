...
//                     .systemInstruction(
//                         Content.builder()
//                             .parts(Arrays.asList(Part.fromText(SYSTEM_PROMPT)))
//                             .build()
//                     )
...
//     // ================================================================
//     // DECLARAÇÃO DAS TOOLS / FUNCTIONS (Usando o SDK Oficial)
//     // ================================================================

//     private FunctionDeclaration criarToolBuscarCliente() {
//         Map<String, Schema> properties = new HashMap<>();
//         properties.put("nomeCliente", Schema.builder().type(Type.STRING).description("Nome do Cliente").build());
//         properties.put("nroCliente", Schema.builder().type(Type.STRING).description("ID do cliente").build());

//         return FunctionDeclaration.builder()
//                 .name("buscarCliente")
//                 .description("Busca informações de um Cliente pelo nome ou ID")
//                 .parameters(Schema.builder().type(Type.OBJECT).properties(properties).build())
//                 .build();
//     }

//     private FunctionDeclaration criarToolAgendarConsulta() {
//         Map<String, Schema> properties = new HashMap<>();
//         properties.put("nroAnimal", Schema.builder().type(Type.INTEGER).description("ID do animal").build());
//         properties.put("nroVeterinario", Schema.builder().type(Type.INTEGER).description("ID do veterinário").build());
//         properties.put("data", Schema.builder().type(Type.STRING).description("Data no formato YYYY-MM-DD").build());
//         properties.put("horario", Schema.builder().type(Type.STRING).description("Horário HH:mm:ss").build());
//         properties.put("nroTipoAtendimento", Schema.builder().type(Type.STRING).description("1 para consulta, 2 para vacina").build());
...
//         Map<String, Schema> properties = new HashMap<>();
//         properties.put("nroTipoAtendimento", Schema.builder().type(Type.INTEGER).description("ID do tipo de atendimento").build());
//         properties.put("nomeCliente", Schema.builder().type(Type.STRING).description("Nome do cliente").build());
//         properties.put("nroAnimal", Schema.builder().type(Type.INTEGER).description("ID do animal").build());
...
//                     .role("user")
//                     .parts(Arrays.asList(Part.fromText(promptUsuario)))
//                     .build();

//             // 2. Pedido de Function Call do Gemini
//             Content modelMsg = Content.builder()
//                     .role("model")
//                     .parts(Arrays.asList(Part.fromFunctionCall(functionCall.name().get(), functionCall.args().orElse(new HashMap<>()))))
//                     .build();
...
//                     .role("user")
//                     .parts(Arrays.asList(Part.fromFunctionResponse(functionCall.name().get(), responseMap)))
//                     .build();
